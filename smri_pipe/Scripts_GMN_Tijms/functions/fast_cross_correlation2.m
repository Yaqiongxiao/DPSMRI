function [rotcorr, rrcorr] = fast_cross_correlation2(rois, rrois, dim,forty)
...
for i = 1:size(n_sum,2)
	...
	nto_be_cor=[nseed nseed(angles(:,2)) nseed(angles(:,3)) nseed(angles(:,4)) nseed(angles(:,5)) nseed(angles(:,6)) nseed(angles(:,7)) nseed(angles(:,8)) nseed(angles(:,9)) nseed(angles(:,10)) nseed(angles(:,11)) nseed(angles(:,12)) nseed(angles(:,13)) nseed(angles(:,14)) nseed(angles(:,15)) nseed(angles(:,16)) nseed(angles(:,17)) nseed(angles(:,18)) nseed(angles(:,19)) nseed(angles(:,20)) nseed(angles(:,21)) nseed(angles(:,22)) nseed(angles(:,23)) nseed(angles(:,24)) nseed(angles(:,25)) nseed(angles(:,26)) nseed(angles(:,27)) nseed(angles(:,28)) nseed(angles(:,29)) nseed(angles(:,30)) nseed(angles(:,31)) nseed(angles(:,32)) nseed(angles(:,33)) nseed(angles(:,34)) nseed(angles(:,35)) nseed(angles(:,36)) nseed(angles(:,37)) nseed(angles(:,38)) nseed(angles(:,39)) nseed(angles(:,40)) nseed(angles(:,41)) nseed(angles(:,42)) nseed(angles(:,43)) nseed(angles(:,44)) nseed(angles(:,45)) nseed(angles(:,46)) nseed(angles(:,47)) nseed(angles(:,48)) nseed(angles(:,49)) nseed(angles(:,50)) nseed(angles(:,51)) nseed(angles(:,52)) nseed(angles(:,53)) nseed(angles(:,54)) nseed(angles(:,55)) nseed(angles(:,56)) nseed(angles(:,57)) nseed(angles(:,58)) nseed(angles(:,59)) nseed(angles(:,60)) nseed(angles(:,61)) nseed(angles(:,62)) nseed(angles(:,63)) nseed(angles(:,64)) nseed(angles(:,65)) nseed(angles(:,66)) nseed(angles(:,67)) nseed(angles(:,68)) nseed(angles(:,69)) nseed(angles(:,70)) nseed(angles(:,71)) nseed(angles(:,72)) nseed(angles(:,73)) nseed(angles(:,74)) nseed(angles(:,75)) nseed(angles(:,76)) nseed(angles(:,77)) nseed(angles(:,78)) nseed(angles(:,79)) nseed(angles(:,80)) nseed(angles(:,81)) nseed(angles(:,82)) nseed(angles(:,83)) nseed(angles(:,84)) nseed(angles(:,85)) nseed(angles(:,86)) nseed(angles(:,87)) nseed(angles(:,88))];
