function [rotcorr, rrcorr] = fast_rank_cross_correlation(rois, rrois, dim,forty)
...
% Convert raw values in rois to ranks --> for tie ranks --> give all tie entries the average of that rank.
rois = tiedrank(rois);
rrois = tiedrank(rrois);
